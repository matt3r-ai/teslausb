...
LAST_PARTITION_DEVICE=$(sfdisk -l "$BOOT_DISK" | tail -1 | awk '{print $1}')
declare -rx LAST_PARTITION_DEVICE
LAST_PART_NUM=${LAST_PARTITION_DEVICE:0-1}
declare -rx LAST_PART_NUM
